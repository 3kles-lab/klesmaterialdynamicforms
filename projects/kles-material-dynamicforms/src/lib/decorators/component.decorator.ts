...
export function FieldMapper(config: { type: string; factory?: (field: IKlesFieldConfig) => AbstractControl<any, any>; ui?: (field: IKlesFieldConfig) => AbstractUiState<any, any> }) {
